...
error_reporting(E_ALL ^ E_NOTICE);
		...
		session_start();
		if  ( ( (isset($_SESSION['access'])) && ($_SESSION['access']=='full_access') ) || ( (isset($_SESSION["user"]["dostup"])) && (sizeof($_SESSION["user"]["dostup"])>0) ) ) {}
		else die('F U');
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,doc,docx,xls,xlsx,rar";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,mp3,png,pdf,zip,doc,docx,xls,xlsx,rar";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,mp3,pdf,txt,zip,doc,docx,xls,xlsx,rar";
